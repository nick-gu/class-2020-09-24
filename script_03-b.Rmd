...
course_10 %>% ggplot(mapping = aes(x = title.new, y = differenceen, fill = department.new)) +
  geom_col() +
  themes_x_discrete(x.text = element_text())
```
...
Our ideal preceptor table would tell us every class's work assigned per day, the amount of time it took each student to complete, and
